...
<div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
       ...
       <!--  <form action="#">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link btn btn-outline-warning" style="background-color: ; color:black;" href="{{url('myappointment')}}">My Appointment</a>
            </li>
       ...
       @csrf
        ...
        <div class="row mb-3">
          ...
          <div class="col-12 py-2 wow fadeInUp">
            ...
            <input type="number" name="phone" id="subject" class="form-control" placeholder="Enter Phone number">
          </div>
          <div class="col-12 py-2 wow fadeInUp">
        ...
        <button type="submit" class="btn btn-outline-primary" style="background-color:;">Send Message</button>
      </form>
    </div>
  </div>
 ...
 <!--contact secttion-->
  <div class="footer">
  <div class="container">
  <h1 class="mt-3 mb-5" style="text-align: center;" >Contact Us</h1>
    <div class="row">
      <div class="col-md-8 col-sm-12">
                <h2 class="" style="font-family: Arial, Helvetica, sans-serif;">Location</h2>
                 <p><i class="fa fa-home"></i>&nbsp;Buddha Colony Opposite:W.H Khan Patna-1, Bihar,India</p>
                             
                 <h2 class="" style="font-family: Arial, Helvetica, sans-serif;">Contact info</h2>
                 <p><i class="fa fa-phone"></i>&nbsp;+6203677448,&nbsp7488122480</p>
                       
                 <h2 class="" style="font-family:Arial, Helvetica, sans-serif">Email-id</h2>
                 <p><i class="fa fa-envelope"></i>&nbsp  drfaizashraf.87.born@gmail.com</p>    
                 
                 <h2 class="" style="font-family: Arial, Helvetica, sans-serif;">whatsapp number</h2>
                 <p><i class="fa fa-whatsapp"></i>&nbsp+91 7488122480</p>                         
      ...
      <div class="col-md-4 col-sm-12">
        <img src="../assets/img/faizwp.jpeg" alt="contactimg" style="height: 300px;width: 400px;">
...
<div class="whatsapp" style="background-color: black;">
  <div class="container mt-5 mb-3">
    <div class="row">
      <div class="col-md-12 sm-12 mt-3 mb-3">
        <h3 class="mb-3" style="color: white;">If you Have Any Questions Call Us On :- +91 7488122480</h3>
        <input type="submit" class="btn btn-danger w-10" value="Get In Touch">
      </div>
    </div>
  </div>
</div>
